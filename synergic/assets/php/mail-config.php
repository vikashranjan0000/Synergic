...
$admin_email_to        = 'ui.sparc@gmail.com'; /* Admin Email; Who Will Get The Contact Email Alert */

$admin_email_name   = "Test Admin"; /* Admin Name/Company name who will get the email alert */

$admin_email_from       = 'ui.sparc@gmail.com'; /* Admin email from which email address email will be sent */

$admin_email_from_name  = 'Developer'; /* Admin name from which email will be sent */


$use_custom_subject = false; /* If you want to use custom subject then set true. To use form subject just ignore it. */

$admin_email_subject = 'A new message from Developer Demo'; /* Custom email subject what the admin will get as contact email alert*/
 ...
 * @default: false
 */
$mail_send_type = true; /*if $mail_send_type is set to smtp, then complete this config*/
